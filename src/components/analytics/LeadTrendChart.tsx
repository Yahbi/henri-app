          ...
          <AreaChart data={data} margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
            <defs>
              <linearGradient id="colorLeads" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#D4886A" stopOpacity={0.25} />
                <stop offset="95%" stopColor="#D4886A" stopOpacity={0.02} />
              </linearGradient>
              <linearGradient id="colorWins" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#3D9970" stopOpacity={0.25} />
                <stop offset="95%" stopColor="#3D9970" stopOpacity={0.02} />
              </linearGradient>
            </defs>
